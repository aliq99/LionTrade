...
with st.sidebar:
    ...
    if strategy_choice == "Momentum":
        # ... Add Momentum-specific sliders here if you want to control them from the UI
        pass
    ...
    st.caption("⚠️ Note: Start/Stop buttons are not yet connected.")
...
tab1, tab2, tab3 = st.tabs(
    ["📊 Overview & Live Data", "📈 Performance", "🔄 Trade History"]
)

with tab1:
    col_main, col_ai = st.columns([3, 1])  # Give more space to portfolio
    with col_main:
